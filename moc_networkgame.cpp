...
**
** Created: Wed Mar 27 22:55:17 2013
...
static const char qt_meta_stringdata_NetworkGame[] = {
    "NetworkGame\0\0readyRead()\0readTcpData()\0"
};
...
const QMetaObjectExtraData NetworkGame::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject NetworkGame::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_NetworkGame,
      qt_meta_data_NetworkGame, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &NetworkGame::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_NetworkGame))
        return static_cast<void*>(const_cast< NetworkGame*>(this));
